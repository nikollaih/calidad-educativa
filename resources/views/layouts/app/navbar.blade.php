            ...
            <div class="flex flex-row items-center ml-auto">
                <li class="relative group">
                    <a class="flex items-center layout-menu-toggle" href="javascript:void(0);" onclick="toggleDropdown(event)">
                        ...
                        <span class="absolute bottom-0 right-0 w-3 h-3 bg-green-500 !border border-white rounded-full"></span>
                    </a>
                            ...
                            <a class="block px-2 py-1 hover:bg-white/50 transition-all duration-200" href="{{asset('profile')}}">
                                <div class="flex items-center gap-3">
                                    <div class="relative flex-shrink-0">
                                        ...
                                        @endif
                                        <span class="absolute bottom-0 right-0 w-3.5 h-3.5 bg-green-500 !border border-white rounded-full"></span>
                                    </div>

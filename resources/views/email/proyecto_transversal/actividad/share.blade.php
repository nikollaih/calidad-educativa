...
<head>
    ...
    <title>Notificación de Actividad - Proyecto Transversal</title>
</head>
    ...
    <tr>
        <td style="padding: 20px 0;">
            <table role="presentation" style="width: 100%; max-width: 600px; margin: 0 auto; background-color: #ffffff; border-collapse: collapse;">
                ...
                <tr>
                    <td style="padding: 30px 30px 20px 30px;">
                        ...
                        <p style="margin: 0; color: #333333; font-size: 16px; line-height: 1.6;">
                            Le informamos que ha sido notificado(a) en relación con una actividad asociada al siguiente proyecto transversal:
                        </p>
                    </td>
                </tr>
                ...
                <!-- Datos del Proyecto Transversal -->
                <tr>
                    <td style="padding: 0 30px 20px 30px;">
                        <h2 style="margin: 0 0 15px 0; color: #2c3e50; font-size: 18px; font-weight: bold;">Proyecto Transversal</h2>
                        <table role="presentation" style="width: 100%; border-collapse: collapse;">
                            <tr>
                                <td style="padding: 15px; background-color: #f8f9fa; border-left: 3px solid #2980b9;">
                                    <p style="margin: 0 0 8px 0; color: #2c3e50; font-size: 15px; line-height: 1.5;">
                                        <strong>Nombre:</strong> {{data_get($proyectoTransversal,'nombre')}}
                                    </p>
                                    <p style="margin: 0; color: #333333; font-size: 15px; line-height: 1.6;">
                                        <strong>Descripción:</strong> {{data_get($proyectoTransversal,'descripcion')}}
                                    </p>
                                </td>
                            </tr>
                        </table>
                ...
                <tr>
                    <td style="padding: 0 30px 30px 30px; text-align: center;">
                        <table role="presentation" style="margin: 0 auto; border-collapse: collapse;">
                            <tr>
                                <td style="background-color: #2980b9; padding: 15px 40px; border-radius: 5px;">
                                    <a href="{{asset('/')}}" style="color: #ffffff; text-decoration: none; font-size: 16px; font-weight: bold; display: block;">Ver Actividad</a>
                                </td>
                            </tr>
                        </table>
                    </td>

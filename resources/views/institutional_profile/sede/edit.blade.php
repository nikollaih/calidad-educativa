                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" name="nombre_ie" class="form-control" value="Institución Educativa Ejemplo" required>
                            </div>

                            <div class="mb-3">
                                <label for="nit" class="form-label">NIT</label>
                                <input type="text" name="nit" class="form-control" value="800.123.456-1" required>
                            </div>

                            <div class="mb-3">
                                <label for="dane" class="form-label">Código DANE</label>
                                <input type="text" name="dane" class="form-control" value="17654321" required>
                            </div>

                            <div class="mb-3">
                                <label for="email" class="form-label">Correo Electrónico</label>
                                <input type="email" name="email" class="form-control" value="sanjose@colegio.edu.co" required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" name="telefono_ie" class="form-control" value="32339848432" required>
                            </div>

                            <div class="mb-3">
                                <label for="pagina_web" class="form-label">Página Web</label>
                                <input type="url" name="pagina_web" class="form-control" value="https://ejemplo.pagina">
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="nombre_rector" class="form-control" value="marco aurelio rojas" required>
                            </div>

                            <div class="mb-3">
                                <label for="nombre_coordinador" class="form-label">Nombre del Coordinador/es</label>
                                <input type="text" name="nombre_coordinador" class="form-control" value="rodolfo gutierrez">
                            </div>
                        </div>
                    </div>

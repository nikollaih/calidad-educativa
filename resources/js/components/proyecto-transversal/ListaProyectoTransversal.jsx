...
export default function ListaProyectoTransversal({ agregarUrl, proyectosTransversales, institucionId, esRector = false, csrfToken = '' }) {
    ...
    const [proyectos, setProyectos] = useState(proyectosTransversales.data);
    ...
    return (
        <div className="!border border-custom-blue-light rounded-md mt-3">
            <div className="card">
                <h1 className="p-2 px-3 text-custom-primary">Proyectos pedagógicos transversales</h1>
                ...
                {loading && <div class="text-center"><div class="spinner-border text-primary" role="status"><span class="visually-hidden">Cargando...</span></div></div>}
                                ...
                                <tr key={proyectoTransversal.id}>
                                    ...
                                    <td>
                                        {proyectoTransversal.acto_administrativo?.ruta ? (
                                            <a href={`/storage/${proyectoTransversal.acto_administrativo.ruta}`} target="_blank"><i class={'fa fa-eye'}></i></a>
                                        ) : (
                                            'sin información'
                                        )}
                                    </td>
                                    <td>
                                        ...
                                        />
                                        <CTableActionButton
                                            route={`/${proyectoTransversal.id}/proyecto-transversal-actividades`}
                                            iconClass={'fa-solid fa-users'}
                                            hoverIconColor={'text-custom-primary'}
                                            title={' Actividades e integrantes'}
                                        />
                                        <CTableActionButton
                    ...
                    <CPagination  pagination={proyectosTransversales} />
